...
let rawdata = fs.readFileSync("../inputData/input_allowlist_clean.json");
let input_allowlist_clean = JSON.parse(rawdata);
let rawdata2 = fs.readFileSync("../inputData/input_cyclops_clean.json");
let input_cyclops_clean = JSON.parse(rawdata2);
